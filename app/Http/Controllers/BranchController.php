...
//                    'addresss' => $request->address
    ...
    public function branchProduct($branch,$request){
        ...
        $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'],'manager_id'=>$request['Collection_Manager']];
        $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'],'manager_id'=>$request['Area_Collection_Manager']];
        $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'],'manager_id'=>$request['Regional_Collection_Manager']];
        $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'],'manager_id'=>$request['Zonal_Collection_Manager']];
        $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'],'manager_id'=>$request['National_Collection_Manager']];
        $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'],'manager_id'=>$request['Group_Product_Head']];
        while (isset($request['manager_id'.$i])) {
            // $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['manager_id'.$i]];
            $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['Collection_Manager'.$i]];
            $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['Area_Collection_Manager'.$i]];
            $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['Regional_Collection_Manager'.$i]];
            $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['Zonal_Collection_Manager'.$i]];
            $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['National_Collection_Manager'.$i]];
            $data[]=['branch_id'=>$branch->id,'product_id'=>$request['product_id'.$i],'manager_id'=>$request['Group_Product_Head'.$i]];
            $i++;
        }
