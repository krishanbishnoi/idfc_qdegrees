    ...
    */
    public function model(array $row)
    {
       // echo '<pre>'; print_r( $row); die;
        ...
        //added by kratika
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Collection_Manager']->id,'type'=>'Collection_Manager','bucket'=>$row['bucket'],'auditor_id'=> $auditor_id[0],'acm_id'=>$acm_id,'zcm_id'=>$zcm_id,'rcm_id'=>$rcm_id,'ncm_id'=>$ncm_id,'gph_id'=>$gph_id];
        }
  ...
  /*   public function rules(): array
    ...
    public function customValidationMessages()
    {
        return [
            ...
            'lob.in' => 'The lob must be in collection,commercial_vehicle,rural,alliance','credit_card',
        ];
    } */
}
