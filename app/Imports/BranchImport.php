...
class BranchImport implements ToModel, WithHeadingRow,WithValidation,WithChunkReading
{
    ...
    */
    ...
    //    dd($row);
        ...
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Collection_Manager']->id,'type'=>'Collection_Manager','bucket'=>$row['bucket']];
        }
        if(isset($datauser['Area_Collection_Manager'])){
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Area_Collection_Manager']->id,'type'=>'Area_Collection_Manager','bucket'=>$row['bucket']];
        }
        if(isset($datauser['Regional_Collection_Manager'])){
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Regional_Collection_Manager']->id,'type'=>'Regional_Collection_Manager','bucket'=>$row['bucket']];
        }
        if(isset($datauser['Zonal_Collection_Manager'])){
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Zonal_Collection_Manager']->id,'type'=>'Zonal_Collection_Manager','bucket'=>$row['bucket']];
        }
        if(isset($datauser['National_Collection_Manager'])){
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['National_Collection_Manager']->id,'type'=>'National_Collection_Manager','bucket'=>$row['bucket']];
        }
        if(isset($datauser['Group_Product_Head'])){
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Group_Product_Head']->id,'type'=>'Group_Product_Head','bucket'=>$row['bucket']];
        }
