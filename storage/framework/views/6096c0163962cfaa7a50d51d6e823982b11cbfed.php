            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-sm float-right" style="margin-right: 5px" href="<?php echo e(route('excelDownloadBranch')); ?>" target="_blank">Export Branch</a>
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr scope="row">
                                    ...
                                    <!-- <div style="display: flex;">
                                        ...
                                        <a href="<?php echo e(url('branch/'.Crypt::encrypt($row->id))); ?>" class="btn btn-xs btn-danger" title="Delete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\idfc_qdegrees\resources\views/branch/list.blade.php ENDPATH**/ ?>