...
<div class="container mt-5">
    ...
    <!-- BACK BUTTON -->
    <a href="<?php echo e(route('select.branch')); ?>" class="back-btn">
    ← Back
</a>


    <h2 class="text-center mb-4 fw-bold">
        📊 Reports for Branch: <span class="text-primary"><?php echo e($branch); ?></span>
    </h2>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 mb-4">
            <a href="<?php echo e(route('monthly.analysis', $branch)); ?>" target="_blank" class="text-decoration-none">
        ...
        <!-- Agency Wise Delay -->
        <div class="col-md-4 mb-4">
            <a href="<?php echo e(route('agency.wise.delay.deposition', $branch)); ?>" target="_blank" class="text-decoration-none">
        ...
        <!-- Agent Wise Delay -->
        <div class="col-md-4 mb-4">
            <a href="<?php echo e(route('agent.wise.delay.deposition', $branch)); ?>" target="_blank" class="text-decoration-none">
