@if($type=='yard')
    ...
    <div class="col-md-3 form-group">
        ...
        <input list="yard_manager" type="text" name="yard_manager" class="form-control" value="{{$yard->user->name ?? ''}}" onkeyup="changeYardManager(this.value)" onchange="selectYardManager(this.value)">
