        ...
        success: function (res) {
            if (res.data!=null) {
                ...
                jQuery.each(res.data.audit_parameter_result, function (key, value) {
                    data.push(value.orignal_weight)
                    ...
                    html=html+ `<tr>
                        ...
                        <td>
                            ${(value.temp_weight>value.orignal_weight)?
